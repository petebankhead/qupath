...
/**
 * Parameter to represent a Multiline String value.
 * 
...
public class TextParameter extends AbstractParameter<String> {
	...
	TextParameter(String prompt, String defaultValue, String lastValue, String helpText, boolean isHidden) {
		super(prompt, defaultValue, lastValue, helpText, isHidden);
	}

	public TextParameter(String prompt, String defaultValue, String helpText) {
	...
	public Parameter<String> duplicate() {
		return new TextParameter(getPrompt(), getDefaultValue(), getValue(), getHelpText(), isHidden());
	}
}
